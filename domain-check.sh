...
# Revision History:
#  Version 1.7
#    Fix registrar parsing issue for mynic .my server new whois result format -- M. Fauzilkamil Zainuddin < jerungkun at gmail dot com >
#
#  Version 1.6
#    Added support for .my domain names -- M. Fauzilkamil Zainuddin < jerungkun at gmail dot com >
#
#  Version 1.5
...
check_domain_status() 
{
    ...
    if [ "${TLDTYPE}"  == "my" ];
    then
        REGISTRAR=`cat ${WHOIS_TMP} | ${AWK} '/Registration No./' | sed 's/\][ ]*/\] /g' | cut -d ' ' -f4`
    else
